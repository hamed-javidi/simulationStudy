...
class MyHyperModel(kt.HyperModel):
    def build(self, hp):
        ...
        model.add(layers.Conv2D(hp.Choice('conv1', [ 32, 64, 128], default=32), hp.Choice('ksize1', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
        model.add(layers.Conv2D(hp.Choice('conv2', [ 32, 64, 128], default=32), hp.Choice('ksize2', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
        model.add(layers.MaxPooling2D(2, padding='same'))

        model.add(layers.Conv2D(hp.Choice('conv3', [ 32, 64, 128], default=32), hp.Choice('ksize3', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
        model.add(layers.Conv2D(hp.Choice('conv4', [ 32, 64, 128], default=32), hp.Choice('ksize4', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
        model.add(layers.MaxPooling2D(2, padding='same'))

        model.add(layers.Conv2D(hp.Choice('conv5', [ 32, 64, 128], default=64), hp.Choice('ksize5', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
        model.add(layers.Conv2D(hp.Choice('conv6', [ 32, 64, 128], default=64), hp.Choice('ksize6', [3, 5], default=3), 1, padding='same'))
        model.add(layers.Activation('relu'))
...
def GAF_CNN_classifier(X, Y, x_test, y_test, params):
